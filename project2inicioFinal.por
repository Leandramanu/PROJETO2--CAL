programa
{
	...
	//listar karts locados
     ...
     //informar o kart que rendeu mais lucro
     ...
     //Receita e lucro do dia, considerando karts locados
 ...
 * @POSICAO-CURSOR = 1351; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {armazena1, 193, 14, 9}-{armazena3, 193, 29, 9}-{armazena4, 193, 44, 9}-{armazena2, 196, 11, 9};

programa
{
	...
	funcao listarKartD(inteiro j, inteiro u[], real d[], inteiro t[], inteiro q[], inteiro c, inteiro k){ //listar os karts disponiveis
     ...
     funcao alugarKart(inteiro j, inteiro u[], inteiro &t[], inteiro &q[], inteiro l, inteiro k){ //para alugar o kart     	
		...
		para (j=0; j < 15; j ++){
			...
			se(q[j] == 1){
	          	...
	          	se (u[j] != 0){
	          		...
	          		escreva(" E ai vamo pagar? Segue os kart com aluguel pendente: ", lK)
 ...
 * @POSICAO-CURSOR = 4705; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {armazena1, 188, 14, 9}-{armazena3, 188, 29, 9}-{armazena4, 188, 44, 9}-{armazena2, 191, 11, 9};
